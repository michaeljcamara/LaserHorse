class Tetrahedron {
  ...
  void drawShape() {
    ...
    Matrix destinationTranslate = new Matrix(4,4);
      ...
      destinationTranslate.setValue(0, 0, 1);
      destinationTranslate.setValue(0, 1, 0);
      destinationTranslate.setValue(0, 2, 0);
      destinationTranslate.setValue(0, 3, x);
      
      destinationTranslate.setValue(1, 0, 0);
      destinationTranslate.setValue(1, 1, 1);
      destinationTranslate.setValue(1, 2, 0);
      destinationTranslate.setValue(1, 3, y);
      
      destinationTranslate.setValue(2, 0, 0);
      destinationTranslate.setValue(2, 1, 0);
      destinationTranslate.setValue(2, 2, 1);
      destinationTranslate.setValue(2, 3, z);
      
      destinationTranslate.setValue(3, 0, 0);
      destinationTranslate.setValue(3, 1, 0);
      destinationTranslate.setValue(3, 2, 0);
      destinationTranslate.setValue(3, 3, 1);
